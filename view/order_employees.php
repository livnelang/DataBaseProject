    ...
    <main>
        <div class="panel panel-default data-content">
            <div class="panel-heading">
                <h3 class="panel-title">Choose Order Id</h3>
            </div>
            <div class="panel-body">

                <form action="show_order_emp.php" method="post">
                    ...
                    $sql = "SELECT order.idOrder FROM mydb.order";
                    ...
                    <div class="form-group col-xs-3 user-list">
                        ...
                        <select class="select_dec" name="order_id">
                            <?php
                    ...
                    <div class="clear"></div>
                    <div class="form-group col-xs-3 user-list">
                        <button type="submit" class="btn btn-default">Show Employees</button>
                    </div>

                </form>
                <div id="order_emp" class="add_pic"></div>
